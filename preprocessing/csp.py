...
from preprocessing.filters import butter_fir_filter
from preprocessing.eig import gevd
...
def generate_projection(data,class_vec,NO_csp,filter_bank,time_windows,NO_classes=2):
